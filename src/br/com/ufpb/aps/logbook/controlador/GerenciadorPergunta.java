...
public class GerenciadorPergunta {
	...
	public void adicionarPergunta(Pergunta novaPergunta) throws PerguntaSemDadosException, PerguntaJaCadastradaException 
	{
		if(novaPergunta.getCodPergunta() == null || novaPergunta.getPergunta() == null)
			throw new PerguntaSemDadosException ("Imposs�vel adicionar pergunta sem dados!");
		
		try
		{
			pesquisarPergunta(novaPergunta.getCodPergunta());
			throw new PerguntaJaCadastradaException("J� existe pergunta cadastrada com o c�digo informado!");
		}
	...
	public Pergunta pesquisarPergunta(String codPergunta) throws PerguntaInexistenteException
	{
		...
		throw new PerguntaInexistenteException("N�o existe esta pergunta no Sitema LogBook");
	}
