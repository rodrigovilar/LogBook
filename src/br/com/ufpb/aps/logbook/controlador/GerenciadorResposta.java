...
public class GerenciadorResposta {
	...
	public void adicionarRespota(Resposta novaResposta)
		...
		if (novaResposta.getCodResposta() == null
				|| novaResposta.getConteudo() == null)
			throw new RespostaSemDadosException(
					"Impossível adicionar uma resposta sem os Dados!");
		try {
			pesquisarResposta(novaResposta.getCodResposta());
			throw new RespostaJaCadastradaException(
					"Já existe resposta cadastrada com o codigo informado!");
	...
	public Resposta pesquisarResposta(String codResposta)
		...
		throw new RespostaInexistenteException(
				"Não existe esta resposta com este codigo no Sitema LogBook");
	}
