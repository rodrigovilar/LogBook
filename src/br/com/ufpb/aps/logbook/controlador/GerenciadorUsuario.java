...
public class GerenciadorUsuario {
	...
	public void adicionarUsuario(Usuario novoUsuario)
		...
		if (novoUsuario.getEmail() == null || novoUsuario.getCodigo() == null
		...
		try {
			...
			throw new UsuarioJaCadastradoException(
					"J� existe usu�rio cadastrado com o c�digo informado!");
	...
	public Usuario pesquisarUsuario(String codigo)
		...
		throw new UsuarioInexistenteException(
				"N�o existe usuario com este codigo no Sitema LogBook");
	}
