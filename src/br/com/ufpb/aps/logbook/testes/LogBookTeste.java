...
public class LogBookTeste {
	...
	public void criarFacadeLogbook() {
		fachada = new LogbookFachada(); // cria uma nova fachada no começo de
										// cada
										// teste, para zerar o estado da fachada
										// e deixar os testes independentes
	}
	...
	@Test
	public void testCrudProfessoro() {
